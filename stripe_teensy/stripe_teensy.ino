...
unsigned int BOT_ROW = 18; 
unsigned int NUM_ROWS = 32; 
unsigned int NUM_PIXELS = BOT_ROW + NUM_ROWS;
...
//paint just top row
  for (_i = BOT_ROW; _i < NUM_PIXELS; _i++) {
...
//    r = red(color), g = green(color), b = blue(color);
  ...
  //mimic top row on bottom row (less pixels)
  for (_i = 0; _i < BOT_ROW; _i++) {
    int reverse_i = BOT_ROW - 1 - _i;
    leds[reverse_i].r = leds[map(_i,0,BOT_ROW,BOT_ROW,NUM_PIXELS)].r;
    leds[reverse_i].g = leds[map(_i,0,BOT_ROW,BOT_ROW,NUM_PIXELS)].g;
    leds[reverse_i].b = leds[map(_i,0,BOT_ROW,BOT_ROW,NUM_PIXELS)].b;
  }
